...
// more functions 
  ...
  // mysqli_fetch_asso(); this is the same as mysqli_fetch_array($run_query, MYSQLI_ASSOC);
// this code below is thee same thing as the search array below
 ...
 // $result =  mysqli_fetch_array($run_query );
  ...
  // we can use while loop to get all the data
...
// $result = mysqli_fetch_array($run_query, MYSQLI_NUM);
// the code below is the same as the num above 
